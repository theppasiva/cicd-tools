module "jenkins" {
  ...
  vpc_security_group_ids = ["sg-0aca0f9acfc45b286"] #replace your SG
  subnet_id = "subnet-01f20410a65983c8a" #replace your Subnet
...
module "jenkins_agent" {
  ...
  instance_type          = "t3.small"
  vpc_security_group_ids = ["sg-0aca0f9acfc45b286"]
